			...
			<view class="record-container">
				<view style="background-color: #ffffff;border-radius: 8px;padding: 20rpx;">
					...
					<u-upload @afterRead="imgRead" style="margin-top: 20rpx;">
						<image :src="bodyData.medical_img" v-if="bodyData.medical_img" style="border-radius: 15rpx;" mode="aspectFit">
						</image>
				...
				<view style="background-color: #ffffff;border-radius: 8px;padding: 20rpx;margin-top: 20rpx;">
					<view>诊断记录:</view>
					<video :src="bodyData.inquiry_video" v-if="bodyData.inquiry_video" style="margin-top: 20rpx;"></video>
					<u-upload @afterRead="videoRead" style="margin-top: 20rpx;" accept="video">
						<!-- <img v-if="bodyData.inquiry_video" src="@/static/images/video.png" alt=""
...
<script>
	...
	import {
		queryInquiryRecordById, queryMedialRecordInformation
	...
	export default {
		...
		methods: {
			...
			async getRecordData(id) {
				const res = await await queryMedialRecordInformation(id)
				this.bodyData = res.data[0]
			}
		}
	}
</script>
